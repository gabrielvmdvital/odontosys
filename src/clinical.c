...
// 5) Padrão crescimento (sngocn) | OBS: Possivelmente será um só com o item 4, verificar como se dá a relação da distancia e angulo


// 6) Posição incisivo sup (medida linear: na1_dist)
...
// 7) Inclinação incisivo sup (medida angular: na1_ang)
...
// 8) Posição incisivo inf (na2_dist)
        char str_pos_incinf[20];



// 9) Inclinação incisivo inf (na2_ang)
        char str_inc_incinf[20];


// 10) Perfil facial (perf_tegument)
